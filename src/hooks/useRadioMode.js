...
export function useRadioMode({ tracks, onLoadAndPlay, onStop, rjVolume = 1 }) {
  ...
  }, [tracks, onLoadAndPlay]) // eslint-disable-line react-hooks/exhaustive-deps
  ...
  const stop = useCallback(() => {
    ...
    setTimeLeft(null)
    onStop()
  }, [onStop]) // eslint-disable-line react-hooks/exhaustive-deps

  const toggle = useCallback((startIndex = 0) => {
